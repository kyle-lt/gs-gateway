...
# I'm Using the "Complete" Directory

# Routes

### http://localhost:9999/get
### http://localhost:9999/headers
### http://localhost:9999/ip
### http://localhost:9999/user-agent
### http://localhost:9999/anything
### http://localhost:9999/uuid
### http://localhost:9999/stream/{x}
### http://localhost:9999/github
### http://localhost:9999/dzone
### http://localhost:9999/garagesale
